...
class HEROSort
{
	...
	public int nextPos()
	{
		...
		//now to get the speed of the next guy and see if he acts on segment.
		//if not redo the above until you get someone who does.
		RollValue x = getCurrent();
		if ( !HERO.actsOnSegment(x.getA(), segment ) )
			return nextPos();
		return position;
	}
